...
class ExpenseWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.final_statement = QLabel("None")
        self.statement_layout.addWidget(self.final_statement)
    ...
    def update_statement_label(self):
        ...
        self.final_statement.setText(f"Type : {type} | Amount : {amount} | Method : {method}\nNote : {note} | Date : {date}\n")
